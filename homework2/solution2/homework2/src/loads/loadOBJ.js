					...
					object.traverse(function (child) {
						if (child.isMesh) {
							...
							switch (objMaterial) {
								...
								case 'EnvDiffuseMaterial':
									material = buildEnvDiffuseMaterial("./src/shaders/envDiffuseShader/envDiffuseVertex.glsl", "./src/shaders/envDiffuseShader/envDiffuseFrag.glsl")
									break;
